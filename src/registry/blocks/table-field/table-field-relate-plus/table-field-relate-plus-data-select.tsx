...
import type { RelateFieldProps } from '@/registry/blocks/table-field/table-field-relate/types'

export interface TableFieldRelatePlusDataSelectProps extends RelateFieldProps {
  relateSchema: {
    relateTo?: string
...
const TableFieldRelatePlusDataSelect: React.FC<TableFieldRelatePlusDataSelectProps> = (props) => {
...
export { TableFieldRelatePlusDataSelect }
export default TableFieldRelatePlusDataSelect
