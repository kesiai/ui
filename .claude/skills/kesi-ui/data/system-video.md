...
import {
  VideoWidget
} from '@/components/kesi/video-widget/video-widget';
import {
  VideoButton
} from '@/components/kesi/video-button/video-button';
import {
  VideoPlaybackWidget
} from '@/components/kesi/video-playback-widget/video-playback-widget';
import {
  VideoTimeAxisWidget
} from '@/components/kesi/video-time-axis/video-time-axis';
import {
  VideoPeriodsWidget
} from '@/components/kesi/video-periods-widget/video-periods-widget';
