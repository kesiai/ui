...
export interface TableFieldMapProps {
  input: {
    value?: {
      name?: string
      lng?: number
...
const TableFieldMap = React.forwardRef<HTMLInputElement, TableFieldMapProps>(
  (props, ref) => {
...
TableFieldMap.displayName = 'TableFieldMap'

export { TableFieldMap }
export default TableFieldMap
