...
const renderViewActionsCodePreview = (props: Record<string, any>) => {
  ...
  return `import { Actions } from '@/registry/blocks/view/view-actions/view-actions'
import { CreateAction, ViewAction, EditAction, DeleteAction, ExportAction, CopyAction } from '@/registry/blocks/view/view-actions/view-actions'
