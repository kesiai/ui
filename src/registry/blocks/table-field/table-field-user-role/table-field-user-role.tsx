...
export interface TableFieldUserRoleOption {
  value: string
  label: string
  key: string
  item?: any
...
export interface TableFieldUserRoleProps {
  input?: {
    value?: any
...
const TableFieldUserRoleSelect: React.FC<TableFieldUserRoleProps> = (props) => {
  const { field, input, label, disabled, mode = 'single' } = props
  const [loading, setLoading] = React.useState(false)
  const [options, setOptions] = React.useState<TableFieldUserRoleOption[]>([])
...
const TableFieldUserRole: React.FC<TableFieldUserRoleProps> = (props) => {
  ...
  return <TableFieldUserRoleSelect input={input} field={field} mode={mode} disabled={disabled} label={label} />
}

export { TableFieldUserRole }
export default TableFieldUserRole
