...
const renderViewBatchOperationCodePreview = (props: Record<string, any>) => {
  ...
  return `import { BatchActions } from '@/registry/blocks/view/view-batch/view-batch'
import { BatchDeleteAction, BatchChangeAction } from '@/registry/blocks/view/view-batch/view-batch'
