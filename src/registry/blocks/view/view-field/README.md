...
已将旧代码 `src/src/TableFieldRender.js` 中的字段渲染逻辑迁移到新版 `src/registry/blocks/view/view-field/field-map.tsx` 中。
...
```tsx
import { ViewFieldRender } from '@/registry/blocks/view/view-field/field-map'
...
```tsx
import fieldMap from '@/registry/blocks/view/view-field/field-map'
