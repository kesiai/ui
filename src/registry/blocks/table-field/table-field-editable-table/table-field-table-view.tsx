...
export interface TableFieldTableViewProps {
  input?: {
    value?: any[]
  ...
  schema?: any
  columns?: TableFieldTableViewColumn[]
  selectedRows?: any[]
...
const TableFieldTableView: React.FC<TableFieldTableViewProps> = (props) => {
...
export { TableFieldTableView }
export default TableFieldTableView
