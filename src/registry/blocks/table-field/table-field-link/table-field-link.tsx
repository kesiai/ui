...
export interface TableFieldLinkProps {
  input?: {
    value?: string
...
const TableFieldLink = React.forwardRef<HTMLDivElement, TableFieldLinkProps>(
  (props, ref) => {
...
TableFieldLink.displayName = 'TableFieldLink'

export { TableFieldLink }
