...
```tsx
import { BatchActions } from '@/registry/components/view-batch/view-batch'
...
```tsx
import { BatchDeleteAction } from '@/registry/components/view-batch/view-batch'
...
```tsx
import { BatchChangeAction } from '@/registry/components/view-batch/view-batch'
...
```tsx
import { BatchActions, BatchChangeAction } from '@/registry/components/view-batch/view-batch'
