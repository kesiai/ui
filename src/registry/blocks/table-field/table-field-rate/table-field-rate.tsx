...
export interface TableFieldRateProps {
  input: {
    value?: number
...
const TableFieldRate = React.forwardRef<HTMLDivElement, TableFieldRateProps>(
  (props, ref) => {
...
TableFieldRate.displayName = 'TableFieldRate'

export { TableFieldRate }
export default TableFieldRate
