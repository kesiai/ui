...
import { Card, CardContent } from '@/registry/components/ui/card/card'
import { Button } from '@/components/ui/button'
import { ChevronDown, ChevronUp } from 'lucide-react'
import { fieldRender } from '@/registry/blocks/table-field/table-field-relate/utils'

export interface TableFieldRelatePlusDataShowProps {
  relateSchema: {
...
const ItemShow: React.FC<{
  relateSchema: TableFieldRelatePlusDataShowProps['relateSchema']
  val: any
  field?: TableFieldRelatePlusDataShowProps['field']
  detailPage?: boolean
...
const TableShow: React.FC<TableFieldRelatePlusDataShowProps> = (props) => {
...
const TableFieldRelatePlusDataShow: React.FC<TableFieldRelatePlusDataShowProps> = (props) => {
...
export { TableFieldRelatePlusDataShow }
export default TableFieldRelatePlusDataShow
