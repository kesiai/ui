...
```tsx
import { ViewAdvancedFilter, FilterRule, LogicOperator } from '@/registry/components/view-advanced-filter/view-advanced-filter'
...
```tsx
import { ViewAdvancedFilter, FilterField } from '@/registry/components/view-advanced-filter/view-advanced-filter'
import { useSetModelState, useModelGetItems } from '@airiot/client'
