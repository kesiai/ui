...
```tsx
import { BatchDeleteAction } from '@/components/kesi/view-batch/view-batch'
...
```tsx
import { BatchChangeAction } from '@/components/kesi/view-batch/view-batch'
...
```tsx
import { BatchDeleteAction, BatchChangeAction } from '@/components/kesi/view-batch/view-batch'
