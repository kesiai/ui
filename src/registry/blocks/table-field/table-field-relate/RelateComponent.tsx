...
export interface TableFieldRelateProps {
  input?: {
    value?: any
...
/**
 * TableFieldRelate - 简单关联字段组件
 * 用于内部表关联（同一个表内的字段关联）
 */
const TableFieldRelate: React.FC<TableFieldRelateProps> = (props) => {
...
export { TableFieldRelate }
export default TableFieldRelate
