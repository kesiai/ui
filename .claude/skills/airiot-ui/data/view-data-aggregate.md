...
> **重要**: view-data-aggregate 是 视图系统 的子组件，不能单独使用。
>
...
```tsx
import { ViewDataAggregate } from '@/components/airiot/view-data-aggregate/view-data-aggregate'
...
```tsx
import { ViewDataAggregate, AggregateField } from '@/components/airiot/view-data-aggregate/view-data-aggregate'
