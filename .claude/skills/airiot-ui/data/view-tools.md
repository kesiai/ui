...
> **重要**: view-tools 是 视图系统 的子组件，不能单独使用。
>
...
```tsx
import { CountTool } from '@/components/airiot/view-tools/view-tools'
...
```tsx
import { PageSizeTool } from '@/components/airiot/view-tools/view-tools'
...
```tsx
import { ColumnsTool } from '@/components/airiot/view-tools/view-tools'
...
```tsx
import { Tools } from '@/components/airiot/view-tools/view-tools'
import { CreateAction } from '@/components/airiot/view-actions/view-actions'
import { Button } from '@/components/ui/button'
...
```tsx
import { Tools, PageSizeTool } from '@/components/airiot/view-tools/view-tools'
