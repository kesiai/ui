...
```tsx
import { Tools } from '@/registry/components/view-tools/view-tools'
...
```tsx
import { CountTool } from '@/registry/components/view-tools/view-tools'
...
```tsx
import { PageSizeTool } from '@/registry/components/view-tools/view-tools'
...
```tsx
import { ColumnsTool } from '@/registry/components/view-tools/view-tools'
...
```tsx
import { Tools, PageSizeTool } from '@/registry/components/view-tools/view-tools'
