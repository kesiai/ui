...
export interface TableFieldRelatePlusAddRecordBtnProps {
  relateSchema: {
    allowAdd?: boolean
...
const TableFieldRelatePlusAddRecordBtn: React.FC<TableFieldRelatePlusAddRecordBtnProps> = (props) => {
...
export { TableFieldRelatePlusAddRecordBtn }
export default TableFieldRelatePlusAddRecordBtn
