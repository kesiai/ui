...
export interface TableFieldNumberProps {
  input: {
    value?: number
...
const TableFieldNumber = React.forwardRef<HTMLInputElement, TableFieldNumberProps>(
  (props, ref) => {
...
TableFieldNumber.displayName = 'TableFieldNumber'

export { TableFieldNumber }
