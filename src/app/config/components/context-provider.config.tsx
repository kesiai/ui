import { ContextProvider, useContextProvider, type Table, type TableData } from '@/registry/blocks/containers/context-provider/context-provider'
...
const renderContextProviderCodePreview = (props: Record<string, any>) => {
  ...
  let code = `import { ContextProvider, useContextProvider } from '@/registry/blocks/containers/context-provider/context-provider'
