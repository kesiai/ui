...
const renderViewToolsCodePreview = (props: Record<string, any>) => {
  ...
  return `import { Tools } from '@/registry/blocks/view/view-tools/view-tools'
import { CountTool, PageSizeTool, ColumnsTool } from '@/registry/blocks/view/view-tools/view-tools'
