...
```tsx
import { Popover } from '@/registry/components/kesi/container-popover'
...
```tsx
import { Popover } from '@/registry/components/kesi/container-popover'
import { Avatar } from '@/registry/components/kesi/avatar/avatar'
...
```tsx
import { Popover } from '@/registry/components/kesi/container-popover'
import { Button } from '@/registry/components/kesi/button/button'
