...
import {
  GisMapCore
} from '@/components/kesi/gis-map-core/gis-map-core';
import {
  GisCustomLayer
} from '@/components/kesi/gis-custom-layer/gis-custom-layer';
import {
  GisPolygonDraw
} from '@/components/kesi/gis-polygon-draw/gis-polygon-draw';
import {
  GisTableLayer
} from '@/components/kesi/gis-table-layer/gis-table-layer';
import {
  GisWarnLayer
} from '@/components/kesi/gis-warn-layer/gis-warn-layer';
import {
  GisXyzTile
} from '@/components/kesi/gis-xyz-tile/gis-xyz-tile';
import {
  GisGeojsonParse
} from '@/components/kesi/gis-geojson-parse/gis-geojson-parse';
import {
  GisGeoserverWMS
} from '@/components/kesi/gis-geoserver-wms/gis-geoserver-wms';
