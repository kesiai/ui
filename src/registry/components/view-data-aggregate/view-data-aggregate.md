...
```tsx
import { ViewDataAggregate } from '@/registry/components/kesi/view-data-aggregate/view-data-aggregate'
...
```tsx
import { ViewDataAggregate, AggregateField } from '@/registry/components/kesi/view-data-aggregate/view-data-aggregate'
