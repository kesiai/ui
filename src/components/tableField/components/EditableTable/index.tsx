...
import { EditableTable } from './TableView'
import type { EditableTableColumn } from './TableView'
...
const EditableComponent: React.FC<EditableTableProps> = (props) => {
  ...
  // 构建列配置
  const columns: EditableTableColumn[] = React.useMemo(() => {
