...
export interface TableFieldUploadProps {
  input: {
    value?: any
...
const TableFieldUpload = React.forwardRef<HTMLDivElement, TableFieldUploadProps>(
  (props, ref) => {
...
TableFieldUpload.displayName = 'TableFieldUpload'

export { TableFieldUpload }
export default TableFieldUpload
