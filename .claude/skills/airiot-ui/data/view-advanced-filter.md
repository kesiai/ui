...
```tsx
import { ViewAdvancedFilter, FilterRule, LogicOperator } from '@/components/airiot/view-advanced-filter/view-advanced-filter'
...
```tsx
import { ViewAdvancedFilter, FilterField } from '@/components/airiot/view-advanced-filter/view-advanced-filter'
import { useSetModelState, useModelGetItems } from '@airiot/client'
